...
export default function EstandarRecibosPage() {
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-5 rounded-2xl border border-slate-200 shadow-2xs">
        <div>
          <div className="flex items-center gap-2">
            <span className="text-xs font-bold uppercase tracking-wider text-slate-500">Comprobantes Oficiales</span>
          ...
          <p className="text-xs text-slate-500">Histórico de comprobantes fiscales con numeración correlativa y verificación digital.</p>
        </div>
      </div>
      ...
      <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-2xs text-xs">
        <div className="relative w-full md:w-80">
          ...
          <input
            type="text"
            placeholder="Buscar por nro. recibo, socio..."
            value={searchTerm}
